...
@section('content')
    <div class="max-w-8xl mx-auto">
        ...
        <form method="POST" action="{{ route('videos.store') }}" class="bg-white p-4 rounded shadow mb-6">
            ...
            <input type="text" name="title" placeholder="Video Title" class="border p-2 w-full mb-3">

            <input type="text" name="youtube_url" placeholder="YouTube URL" class="border p-2 w-full mb-3" required>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            @foreach ($videos as $video)
                <div class="bg-white shadow rounded p-3">
                    <iframe width="100%" height="180" src="https://www.youtube.com/embed/{{ $video->youtube_id }}"
